...
La siguiente aplicación interactiva es un buscador de las estadísticas conseguidas por cualquier jugador contra un determinado equipo. Los datos disponibles proceden de la ACB, la Euroliga y la Eurocup. La app está disponible en español y en inglés y necesita unos segundos para cargar todos los datos.
...
Si la app no se muestra bien en la pantalla, [aquí está su enlace original.](https://www.uv.es/vivigui/AppPlayerSummary.html)

**IN ENGLISH:**

The following interactive app is a search engine of the statistics achieved by any player against a certain rival. The data come from the Spanish first division league (ACB), Euroleague and Eurocup. The app is available in Spanish and English and needs a few seconds to load all the data.
...
If this app doesn't appear well on the screen, [here is the link to the app.](https://www.uv.es/vivigui/AppPlayerSummary.html)

<iframe src="https://gvinue.shinyapps.io/AppPlayerSummary/" width=700 height=1000" scrolling="yes" frameborder="no"></iframe>
